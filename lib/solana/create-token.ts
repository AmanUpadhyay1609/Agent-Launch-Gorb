...
export async function createTokenWithWallet({
  ...
  try {
    ...
    const tx1 = new Transaction().add(
      ...
      createInitializeMetadataPointerInstruction(mint, payer.publicKey, mint, TOKEN22_PROGRAM),
      createInitializeMintInstruction(mint, Number(decimals), payer.publicKey, freezeAuth, TOKEN22_PROGRAM),
    )
    ...
    tx2.add(createMintToInstruction(mint, associatedToken, payer.publicKey, mintAmount, [], TOKEN22_PROGRAM))
